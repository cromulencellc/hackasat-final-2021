...
See targets in [Makefile](./Makefile) to build ADCS and COMM board images

## COMM
- Ubuntu 20.04 SD image for RPI CM4 Module
## ADCS
- Ubuntu 18.04.03 root filesystem for Petalinux 2020.2
