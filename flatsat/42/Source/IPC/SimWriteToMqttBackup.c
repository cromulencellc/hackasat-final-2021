...
#ifdef _ENABLE_MQTT_
/**********************************************************************/
void WriteToMqtt(MQTTClient client,  char **Prefix, long Nprefix, long EchoEnabled)
{
      ...
      for(Ipfx=0;Ipfx<Nprefix;Ipfx++) {
         ...
         for(Isc=0;Isc<Nsc;Isc++) {
            if (SC[Isc].Exists) {
               ...
               sprintf(line,"SC[%ld].AC.DynTime = %18.12le\n",
                  Isc,
                  SC[Isc].AC.DynTime);
               if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                  LineLen = strlen(line);
               ...
               sprintf(line,"SC[%ld].AC.PosN = %18.12le %18.12le %18.12le\n",
                  Isc,
                  SC[Isc].AC.PosN[0],
                  SC[Isc].AC.PosN[1],
                  SC[Isc].AC.PosN[2]);
               ...
               sprintf(line,"SC[%ld].AC.VelN = %18.12le %18.12le %18.12le\n",
                  Isc,
                  SC[Isc].AC.VelN[0],
                  SC[Isc].AC.VelN[1],
                  SC[Isc].AC.VelN[2]);
               ...
               for(i=0;i<SC[Isc].AC.Nst;i++) {
                  ...
                  sprintf(line,"SC[%ld].AC.ST[%ld].qbn = %18.12le %18.12le %18.12le %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.ST[i].qbn[0],
                     SC[Isc].AC.ST[i].qbn[1],
                     SC[Isc].AC.ST[i].qbn[2],
                     SC[Isc].AC.ST[i].qbn[3]);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
               ...
               for(i=0;i<SC[Isc].AC.Neps;i++) {
                  sprintf(line,"SC[%ld].AC.EPS[%ld].Wheel_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].Wheel_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].IMU_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].IMU_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].BatteryCapacity = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].BatteryCapacity);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].StarTracker_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].StarTracker_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].MTR_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].MTR_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].SunSensor_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].SunSensor_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].ADCS_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].ADCS_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].CDH_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].CDH_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].COM_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].COM_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].PAYLOAD_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].PAYLOAD_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].MTR_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].MTR_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].Wheel_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].Wheel_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].IMU_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].IMU_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].StarTracker_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].StarTracker_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].SunSensor_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].SunSensor_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].ADCS_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].ADCS_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].COM_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].COM_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].CDH_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].CDH_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].PAYLOAD_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].PAYLOAD_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].BatteryVoltage = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].BatteryVoltage);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].StarTracker_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].StarTracker_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].SunSensor_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].SunSensor_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].PAYLOAD_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].PAYLOAD_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].CurrentUsed = %ld\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].CurrentUsed);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
               ...
               for(i=0;i<SC[Isc].AC.Nsolarr;i++) {
                  sprintf(line,"SC[%ld].AC.SolArr[%ld].Valid = %ld\n",
                     Isc,i,
                     SC[Isc].AC.SolArr[i].Valid);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.SolArr[%ld].PowerOut = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.SolArr[i].PowerOut);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.SolArr[%ld].CurrentOut = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.SolArr[i].CurrentOut);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.SolArr[%ld].Voltage = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.SolArr[i].Voltage);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
               ...
               for(i=0;i<SC[Isc].AC.Nwhl;i++) {
                  ...
                  sprintf(line,"SC[%ld].AC.Whl[%ld].w = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.Whl[i].w);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
               ...
               for(i=0;i<SC[Isc].Neps;i++) {
                  sprintf(line,"SC[%ld].EPS[%ld].Wheel_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].Wheel_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].IMU_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].IMU_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].BatteryCapacity = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].BatteryCapacity);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].StarTracker_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].StarTracker_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].MTR_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].MTR_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].SunSensor_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].SunSensor_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].ADCS_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].ADCS_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].CDH_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].CDH_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].COM_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].COM_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].PAYLOAD_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].PAYLOAD_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].MTR_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].MTR_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].Wheel_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].Wheel_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].IMU_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].IMU_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].StarTracker_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].StarTracker_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].SunSensor_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].SunSensor_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].ADCS_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].ADCS_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].COM_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].COM_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].CDH_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].CDH_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].PAYLOAD_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].PAYLOAD_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].BatteryVoltage = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].BatteryVoltage);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].CapacityUsed = %18.12le\n",
                     Isc,i,
                     SC[Isc].EPS[i].CapacityUsed);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].Wheel_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].EPS[i].Wheel_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].IMU_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].EPS[i].IMU_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].StarTracker_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].EPS[i].StarTracker_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].MTR_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].EPS[i].MTR_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].SunSensor_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].EPS[i].SunSensor_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].ADCS_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].EPS[i].ADCS_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].COM_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].EPS[i].COM_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].PAYLOAD_Switch = %ld\n",
                     Isc,i,
                     SC[Isc].EPS[i].PAYLOAD_Switch);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].EPS[%ld].CurrentUsed = %ld\n",
                     Isc,i,
                     SC[Isc].EPS[i].CurrentUsed);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
               ...
               for(i=0;i<SC[Isc].Nsolarr;i++) {
                  sprintf(line,"SC[%ld].SolArr[%ld].Valid = %ld\n",
                     Isc,i,
                     SC[Isc].SolArr[i].Valid);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].SolArr[%ld].PowerOut = %18.12le\n",
                     Isc,i,
                     SC[Isc].SolArr[i].PowerOut);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].SolArr[%ld].CurrentOut = %18.12le\n",
                     Isc,i,
                     SC[Isc].SolArr[i].CurrentOut);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].SolArr[%ld].Voltage = %18.12le\n",
                     Isc,i,
                     SC[Isc].SolArr[i].Voltage);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
               ...
               if (SC[Isc].AC.ParmLoadEnabled) {
                  ...
                  for(i=0;i<SC[Isc].AC.Ncss;i++) {
                     ...
                     sprintf(line,"SC[%ld].AC.CSS[%ld].IllumBackground = %18.12le\n",
                        Isc,i,
                        SC[Isc].AC.CSS[i].IllumBackground);
                     if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                        LineLen = strlen(line);
                        memcpy(&Msg[MsgLen],line,LineLen);
                        MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.FsCtrl.qtr = %18.12le %18.12le %18.12le %18.12le\n",
                     Isc,
                     SC[Isc].AC.FsCtrl.qtr[0],
                     SC[Isc].AC.FsCtrl.qtr[1],
                     SC[Isc].AC.FsCtrl.qtr[2],
                     SC[Isc].AC.FsCtrl.qtr[3]);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.FsCtrl.qtn = %18.12le %18.12le %18.12le %18.12le\n",
                     Isc,
                     SC[Isc].AC.FsCtrl.qtn[0],
                     SC[Isc].AC.FsCtrl.qtn[1],
                     SC[Isc].AC.FsCtrl.qtn[2],
                     SC[Isc].AC.FsCtrl.qtn[3]);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.FsCtrl.qbl = %18.12le %18.12le %18.12le %18.12le\n",
                     Isc,
                     SC[Isc].AC.FsCtrl.qbl[0],
                     SC[Isc].AC.FsCtrl.qbl[1],
                     SC[Isc].AC.FsCtrl.qbl[2],
                     SC[Isc].AC.FsCtrl.qbl[3]);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.FsCtrl.qimu = %18.12le %18.12le %18.12le %18.12le\n",
                     Isc,
                     SC[Isc].AC.FsCtrl.qimu[0],
                     SC[Isc].AC.FsCtrl.qimu[1],
                     SC[Isc].AC.FsCtrl.qimu[2],
                     SC[Isc].AC.FsCtrl.qimu[3]);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.FsCtrl.SunYawDeadband = %18.12le\n",
                     Isc,
                     SC[Isc].AC.FsCtrl.SunYawDeadband);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.FsCtrl.SunYawRateDeadband = %18.12le\n",
                     Isc,
                     SC[Isc].AC.FsCtrl.SunYawRateDeadband);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
      ...
      memcpy(&Msg[MsgLen],line,LineLen);
      MsgLen += LineLen;
      Success = MqttPublishMessage(client, Msg, MsgLen);
