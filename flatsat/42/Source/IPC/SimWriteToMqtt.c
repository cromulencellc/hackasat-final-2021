...
int WriteToMqtt(MQTTClient client,  char **Prefix, long Nprefix, long EchoEnabled, const char* topic)
{
      ...
      for(Ipfx=0;Ipfx<Nprefix;Ipfx++) {
         ...
         for(Isc=0;Isc<Nsc;Isc++) {
            if (SC[Isc].Exists) {
               ...
               sprintf(line,"SC[%ld].AC.bvn = %18.12le %18.12le %18.12le\n",
                  Isc,
                  SC[Isc].AC.bvn[0],
                  SC[Isc].AC.bvn[1],
                  SC[Isc].AC.bvn[2]);
               ...
               for(i=0;i<SC[Isc].AC.Nfss;i++) {
                  ...
                  sprintf(line,"SC[%ld].AC.FSS[%ld].SunVecS = %18.12le %18.12le %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.FSS[i].SunVecS[0],
                     SC[Isc].AC.FSS[i].SunVecS[1],
                     SC[Isc].AC.FSS[i].SunVecS[2]);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.FSS[%ld].SunVecB = %18.12le %18.12le %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.FSS[i].SunVecB[0],
                     SC[Isc].AC.FSS[i].SunVecB[1],
                     SC[Isc].AC.FSS[i].SunVecB[2]);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
               ...
               for(i=0;i<SC[Isc].AC.Neps;i++) {
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].CSS_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].CSS_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].FSS_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].FSS_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].BATTERY_I = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].BATTERY_I);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].CSS_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].CSS_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].FSS_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].FSS_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].BATTERY_V = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].BATTERY_V);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].AC.EPS[%ld].BATTERY_SOC = %18.12le\n",
                     Isc,i,
                     SC[Isc].AC.EPS[i].BATTERY_SOC);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
               ...
               for(i=0;i<SC[Isc].Nfss;i++) {
                  ...
                  sprintf(line,"SC[%ld].FSS[%ld].SunAng = %18.12le %18.12le\n",
                     Isc,i,
                     SC[Isc].FSS[i].SunAng[0],
                     SC[Isc].FSS[i].SunAng[1]);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].FSS[%ld].SunVecS = %18.12le %18.12le %18.12le\n",
                     Isc,i,
                     SC[Isc].FSS[i].SunVecS[0],
                     SC[Isc].FSS[i].SunVecS[1],
                     SC[Isc].FSS[i].SunVecS[2]);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
                  ...
                  sprintf(line,"SC[%ld].FSS[%ld].SunVecB = %18.12le %18.12le %18.12le\n",
                     Isc,i,
                     SC[Isc].FSS[i].SunVecB[0],
                     SC[Isc].FSS[i].SunVecB[1],
                     SC[Isc].FSS[i].SunVecB[2]);
                  if (!strncmp(line,Prefix[Ipfx],PfxLen)) {
                     LineLen = strlen(line);
                     memcpy(&Msg[MsgLen],line,LineLen);
                     MsgLen += LineLen;
      ...
      printf("Publish MQTT Sensor Message. Status %d, Time: %f\n", Success, SC[0].AC.Time);
      return(Success);
}
#endif
