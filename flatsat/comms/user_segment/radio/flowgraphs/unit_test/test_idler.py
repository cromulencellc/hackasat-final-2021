...
import test_idler_epy_block_0_1_0 as epy_block_0_1_0  # embedded python block



from gnuradio import qtgui

class test_idler(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_idler")
        ...
        self.epy_block_0_1_0 = epy_block_0_1_0.blk(pattern=[0x55])
        ...
        self.msg_connect((self.blocks_random_pdu_0, 'pdus'), (self.epy_block_0_1_0, 'pdu'))
        ...
        self.connect((self.epy_block_0_1_0, 0), (self.blocks_unpack_k_bits_bb_0, 0))
        self.connect((self.epy_block_0_1_0, 0), (self.digital_constellation_modulator_0, 0))
...
def main(top_block_cls=test_idler, options=None):
