...
/* APBUART0 Setup for Interrupts - System Console */
...
{
{"txDescs", DRVMGR_KT_INT, {(unsigned int)128}},
{"rxDescs", DRVMGR_KT_INT, {(unsigned int)128}},
DRVMGR_KEY_EMPTY
};
