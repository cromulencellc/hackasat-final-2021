...
#define PKTMGR_OUTPUT_BUFFER_LEN 1024
...
typedef struct {
   ...
   uint8            syncPattern[4];
   uint8            outputBuffer[PKTMGR_OUTPUT_BUFFER_LEN];
...
**
** Disable TLM output. The commanded IP is always saved and downlink suppression is turned on. If
** downlink is enabled then closes existing socket.
**
*/
