...
static void SendHousekeepingPkt(KIT_TO_HkPkt *HkPkt)
{
   ...
   */
   ...
   HkPkt->PktsPerSec  = (uint16)(KitTo.PktMgr.Stats.AvgPktsPerSec);
   HkPkt->BytesPerSec = (uint32)(KitTo.PktMgr.Stats.AvgBytesPerSec);
...
static int32 InitApp(void)
{
   ...
   */
   ...
   CMDMGR_RegisterFunc(CMDMGR_OBJ, KIT_TO_DISABLE_OUTPUT_CMD_FC,     PKTMGR_OBJ,  PKTMGR_DisableOutputCmd,   PKKTMGR_DISABLE_OUTPUT_CMD_DATA_LEN);
