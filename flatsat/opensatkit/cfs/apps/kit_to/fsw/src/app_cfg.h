...
#define KIT_TO_DISABLE_OUTPUT_CMD_FC     (CMDMGR_APP_START_FC + 11)
...
#define KIT_TO_APP_BASE_EID  (APP_FW_APP_BASE_EID +   0)
#define PKTTBL_BASE_EID      (APP_FW_APP_BASE_EID + 100)
#define PKTMGR_BASE_EID      (APP_FW_APP_BASE_EID + 200)
