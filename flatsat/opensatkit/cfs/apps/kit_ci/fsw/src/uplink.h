...
#define UPLINK_TBL_REGISTER_ERR_EID             (UPLINK_BASE_EID +  8)
#define UPLINK_TBL_VERIFY_EID                   (UPLINK_BASE_EID +  9)

#define UPLINK_TOTAL_EID  10
...
typedef struct {
   ...
   UPLINK_WL_TblEntry Entry[UPLINK_CI_WL_TBL_ENTRIES];
