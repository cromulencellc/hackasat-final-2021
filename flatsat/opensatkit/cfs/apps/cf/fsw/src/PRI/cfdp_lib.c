      ...
      */
{
  ...
  else if ((int)pdu_type == (int)_EOF_)
    {
      if ((my_role == R_1) || (my_role == R_2))
        sane = YES;
      else
  ...
  else if ((int)pdu_type == (int)_ACK_EOF_)
    {
      if (my_role == S_2)
        sane = YES;
      else
  ...
  else if ((int)pdu_type == (int)_NAK_)
    {
      if (my_role == S_2)
        sane = YES;
      else
  ...
  else if ((int)pdu_type == (int)_FIN_)
    {
      if (my_role == S_2)
        sane = YES;
      else
  ...
  else if ((int)pdu_type == (int)_ACK_FIN_)
    {
      if (my_role == R_2)
        sane = YES;
      else
