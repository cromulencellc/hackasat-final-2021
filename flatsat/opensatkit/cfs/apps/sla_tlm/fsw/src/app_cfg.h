/*
** Purpose: Define configurations for the Sla_tlm application.
**
** Notes:
...
#include "cfe.h"
#include "sla_tlm_platform_cfg.h"
#include "osk_app_fw.h"

/******************************************************************************
** Sla_tlm Application Macros
*/

#define  SLA_TLM_MAJOR_VERSION      0
#define  SLA_TLM_MINOR_VERSION      9
#define  SLA_TLM_REVISION           0
#define  SLA_TLM_MISSION_REV        0
...
#define SLA_TLM_BASE_EID (APP_FW_APP_BASE_EID +  0)
