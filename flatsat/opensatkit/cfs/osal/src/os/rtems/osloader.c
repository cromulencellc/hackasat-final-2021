...
// typedef struct LinkMap_t LinkMap_s;

// struct LinkMap_s {
//     unsigned long l_addr;      /* base address */
//     char          *l_name;     /* object name */
//     void*         *l_ld;       /* .dynamic section */
//     LinkMap_t*    *l_next;     /* next link object */
//     LinkMap_t*    *l_prev;     /* previous link object */
//     char          *l_refname;  /* filter reference name */
// };

// typedef struct _dl_info {
// 	const char	*dli_fname;	/* File defining the symbol */
// 	unsigned long *dli_fbase;	/* Base address */
// 	const char	*dli_sname;	/* Symbol name */
// 	unsigned long	*dli_saddr;	/* Symbol address */
// } Dl_info_t;
...
int32 OS_SymbolTableDump_Impl ( const char *filename, uint32 SizeLimit )
{
    ...
    // fprintf(file, "Symbol Table Dump\n");
    // printf("Symbol Table Dump\n");
    // for(i=0; i<OS_MAX_MODULES;i++) {
    //     dl_handle = OS_impl_module_table[i].dl_handle;
    //     dl_status = dlinfo(dl_handle, RTLD_DI_CONFIGADDR, (void *) &curInfo);
    //     if (! dl_status < 0) {
    //         fprintf(file, "%d: Address: 0x%04X, Name: %s\n", i, curInfo.dli_fbase, curInfo.dli_fname);
    //         printf("%d: Address: 0x%04X, Name: %s\n", i, curInfo.dli_fbase, curInfo.dli_fbase);
    //     }
    // }
    // fclose(file);
