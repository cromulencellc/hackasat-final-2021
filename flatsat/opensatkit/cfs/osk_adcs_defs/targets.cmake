...
SET( _FSS_CHALLENGE_ 1 )

message( STATUS "Building for TEAM ${TEAM_NUM}" )

SET(TGT1_NAME cpu1) 
SET(TGT1_APPLIST osk_app_fw cfs_lib cs hs fm kit_sch kit_ci kit_to mqtt_c adcs_io adcs ephem sbn_lite cf eps_mgr)
SET(TGT1_FILELIST cfe_es_startup.scr osk_to_pkt_tbl.json kit_sch_msg_tbl.json kit_sch_sch_tbl.json adcs_ctrl_tbl.json tle.txt sbn_pkt_tbl.json mqtt_ini.json sb2mq_tbl.json mq2sb_tbl.json eps_mgr_cfg_tbl.json flag.txt)
